...
- 🔍 **病例学术价值分析**：内置妇产科病例学术价值分析系统，多维评估病例的特殊性、诊断与治疗创新性以及学术价值
...
除了多医生会诊功能，系统还内置了**妇产科病例学术价值分析系统**，用于深度评估病例的学术价值、创新性和临床意义。

### 功能特点

- **多维度评估**：从病例特殊性、诊断创新性、治疗创新性、学术价值、临床指导意义等多个维度进行分析
- **量化评分**：每个维度提供1-10分的量化评分，并给出综合创新性评分
- **专业建议**：提供改进建议、研究方向和发表建议
- **历史记录**：自动保存分析历史，支持重复查看
- **数据导入**：可从当前会诊直接导入病例信息
- **结果导出**：支持将分析报告导出为图片保存
...
1. 点击顶部菜单栏的 **"病例分析"** 按钮
2. 填写完整的病例信息：
   - 基本信息：患者姓名、性别、年龄、月经史、婚育史等
   - 临床信息：主诉、体格检查、辅助检查、影像学结果
   - 诊疗信息：诊断、治疗方案、治疗效果、随访情况
3. 选择一位AI医生进行分析
4. 点击 **"开始分析"** 按钮
5. 查看生成的创新性分析报告，包括：
   - 病例特殊性评估（罕见度、复杂性、非典型性）
   - 诊断创新性分析（诊断思路、辅助检查、鉴别诊断）
   - 治疗创新性评估（治疗方案、个体化程度、生育力保护）
   - 学术价值评估（病例报告价值、教学价值、研究启示）
   - 临床指导意义（实践指导、推广潜力、安全性考虑）
   - 创新性亮点总结
   - 改进建议与研究方向
   - 综合创新性评分
   - 发表建议
